...
export class LibraryReportComponent{
   ...
   this.fetchsession.getSession().subscribe((session)=>{
    ...
    this.http.post(this.url+ '/' + this.user + '/'+ this.user + '_get_for_user_id',{
     ...
     let student_id = userDetail._id;
      ...
      this.http.post(this.url + '/book/book_get_for_student_ref',{session:this.session,student_id:student_id,access_token:this.cookie})
        .subscribe((library)=>{
          console.log(library.json());
          this.libraryList = library.json();
